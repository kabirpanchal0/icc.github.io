...
import C2collegesdata from './C2collegesdata'
    ...
    return (
        <>
            ...
            <div className="container mt-5 ">
                <div className="row">
                    <div className="col-10 mx-auto">
                        <h1 className='mb-5'>Master's degrees in Business And Management</h1>
                        {
                            C2collegesdata.map((val, ind) => {
