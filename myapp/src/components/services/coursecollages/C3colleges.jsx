...
import C3collegesdata from './C3collegesdata'
    ...
    return (
        <>
            ...
            <div className="container mt-5 ">
                <div className="row">
                    <div className="col-10 mx-auto">
                        <h1 className='mb-5'>Master's degrees in Computer Science & IT</h1>
                        {
                            C3collegesdata.map((val, ind) => {
