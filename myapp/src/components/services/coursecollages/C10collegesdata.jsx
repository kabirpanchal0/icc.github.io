const C10collegesdata = [
    {
        collegetitle: `Forestry`,
        collegetext:"Graduate study is offered in the Department of Forestry leading to the Master of Science (M.S.) in Forestry (Main Campus and Distance Campus) at Mississippi State University. ",
...
export default C10collegesdata