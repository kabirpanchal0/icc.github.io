...
const C6 = () => {
    ...
    return (
        <>
            ...
            <div className="container-fluid mt-5">
                <div className="row">
                    <div className="col-10 mx-auto">
                        <NavLink to="/" className="links">Home<span ><FaAngleRight /></span></NavLink><NavLink to="/disc2" className="links"> Courses <span><FaAngleRight /></span> </NavLink>Journalism & Media
                    </div>
                </div>
            </div>
            ...
            <CommonCourses
                coursetitle="Details about Master in Journalism & Media"
            ...
            <div className="container-fluid  mt-5">
                <div className="row">
                    <div className="col-10  mx-auto">
                        <h4>Best Universities for  Journalism & Media</h4>
