...
const Ukcollages = () => {
  ...
  useEffect(() => {
      axios.get(`http://localhost:5000/ukcolleges`)
          .then(res => {
              if (res.data) {
      ...
      <div className="container-fluid mt-5">
        <div className="row">
          <div className="col-10 mx-auto ">
            <NavLink to="/" className="links">Home<span ><FaAngleRight /></span></NavLink><NavLink to="/countries/6" className="links"> U K <span><FaAngleRight /></span> </NavLink>U K Colleges
          </div>
        </div>
      </div>
      {/* <Coursestable /> */}
      <div className="container-fluid mt-5 ">
        <div className="row">
          <div className="col-12 mx-auto">
            ...
            <h1 className="text-center">U K Colleges</h1>
          </div>
        </div>
      </div>
